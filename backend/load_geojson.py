...
def load_geojson_files():
    ...
    # Database path (parent directory)
    db_path = str(Path(__file__).parent.parent / "agricultural_data.db")

    # GeoJSON files to load with their field names
    geojson_files = [
        {
            "path": str(Path(__file__).parent.parent / "north-of-road-high-res.geojson"),
            "field_name": "North of Road"
        },
        {
            "path": str(Path(__file__).parent.parent / "railroad-pivot-high-res.geojson"),
            "field_name": "Railroad Pivot"
        },
        {
            "path": str(Path(__file__).parent.parent / "south-of-road-high-res.geojson"),
